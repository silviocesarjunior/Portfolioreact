...
import Pizzaria from "../../img/Pizzaria.jpeg";
            ...
            <section id="portfolio">
                <div className="pl">
                    <div className="pl-texts">
                        ...
                        <p className="pl-desc">
                            It is a creative portfolio for your company, shows
                            architectural work, stunning portfolio styles for
                            your tastes.
                        </p>
                    </div>
                    <div className="pl-list">
                        ...
                        <Product img={Pizzaria} />
                        <a href="https://github.com/silviocesarjunior/pizzaria">
                            <button>Source code</button>
                        </a>
                    </div>
                </div>

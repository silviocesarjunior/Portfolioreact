        ...
        <div className="i">
            <div className="i-left">
                <div className="i-left-wrapper">
                    ...
                    <p className="i-desc">
                    Full stack developer with knowledge of Javascript, react, react native, angular, bootstrap and Bulma,firebase database, mongodb. 
                    I am a professional with solid knowledge in SAP PP/MM and excel.
                    </p>
                </div>
                <svg
                    width="75"
